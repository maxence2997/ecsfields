...
<!-- Link related issues: "Closes #N". Remove this section if none. -->
...
- [ ] New public API: includes GoDoc comments and a top-of-file ECS YAML reference
- [ ] Breaking change: major version bump discussed in linked issue
- [ ] ECS schema bump: `docs/ecs-coverage.md` updated
